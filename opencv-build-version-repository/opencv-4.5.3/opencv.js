  ...
  var cv = (function() {
    ...
    return (
      function(cv) {
        ...
        var wasmMemory;
        var wasmTable = new WebAssembly.Table({ "initial": 3496, "maximum": 3496 + 0, "element": "anyfunc" });
        var ABORT = false;
        var EXITSTATUS = 0;
        ...
        var STACK_BASE = 6174064, DYNAMIC_BASE = 6174064, DYNAMICTOP_PTR = 931024;
        ...
        function getBinaryPromise() {
          if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && typeof fetch === "function") {
            return fetch(wasmBinaryFile, { mode:"cors", credentials: "same-origin" }).then(function(response) {
              if (!response["ok"]) {
        ...
        function createWasm() {
          ...
          function instantiateAsync() {
            if (!wasmBinary && typeof WebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && typeof fetch === "function") {
              fetch(wasmBinaryFile, { mode:"cors", credentials: "same-origin" }).then(function(response) {
